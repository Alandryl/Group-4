...
Shader "Group4/Triplanar"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 triplanar6 = TriplanarSamplingSF( _Normal, ase_worldPos, ase_worldNormal, _Falloff, _Tiling, 1.0, 0 );
			o.Normal = UnpackNormal( triplanar6 );
...
/*ASEBEGIN
Version=16400
296.25;81;1007;640;911.073;413.9727;1.3;True;False
...
Node;AmplifyShaderEditor.UnpackScaleNormalNode;21;-650.0879,-57.4821;Float;False;2;0;FLOAT4;0,0,0,0;False;1;FLOAT;1;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
ASEEND*/
//CHKSM=07ADF3A904D797FF8AF842EFC889F64A02D5AAAE